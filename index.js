    ...
    inquirer.prompt (
        [
            ...
            switch (response.selection) {
                case "Manager":
                    newEmployees = new Manager(response.title, response.id, response.email, results.officeNumber)
                    break;
                case "Intern":
                    newEmployees = new intern(response.title, response.id, response.email, results.school)
                    break;
                case "Engineer":
                    newEmployees = new Engineer(response.title, response.id, response.email, results.github)
            }
